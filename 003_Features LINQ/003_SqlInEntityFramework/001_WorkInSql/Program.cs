...
namespace _001_WorkInSql
{
    class Program
    {
        //В Entity Framework доступно также прямое выполнение sql-запросов.
        //Для осуществления прямых sql-запросов к базе данных можно воспользоваться свойством Database, которое имеется у класса контекста данных.
